...
export const shelters: Shelter[] = [
  {
    id: "s1",
    name: "Moscone Community Center",
    distanceMi: 0.8,
    capacity: 500,
    filled: 210,
    address: "747 Howard St",
    amenities: ["Medical", "Pet-friendly", "Wi-Fi"],
  },
  {
    id: "s2",
    name: "Kezar Pavilion",
    ...
    amenities: ["Medical", "Family"],
  },
  {
    id: "s3",
    name: "Bill Graham Auditorium",
    distanceMi: 1.4,
    capacity: 800,
    filled: 340,
    address: "99 Grove St",
    amenities: ["Medical", "Wi-Fi", "Meals"],
  },
];
...
export type Incident = {
  id: string;
  kind: "flood" | "fire" | "accident" | "outage";
  x: number;
  y: number;
  label: string;
};
...
export const initialChecklist: ChecklistItem[] = [
  {
    id: "w1",
    group: "Water & Food",
    text: "Store 1 gallon of water per person per day (3 days)",
    done: true,
  },
...
export const faq: FaqItem[] = [
  {
    ...
    category: "Earthquake",
    summary: "Drop, Cover, and Hold On. Move away from windows and heavy objects.",
  },
  {
    id: "f2",
    title: "Flood safety essentials",
    category: "Flood",
    summary: "Never walk or drive through flooded roads. Move to higher ground.",
  },
  {
    id: "f3",
    title: "Wildfire evacuation checklist",
    category: "Wildfire",
    summary: "Prepare go-bag, know two evacuation routes, sign up for local alerts.",
  },
  {
    id: "f4",
    title: "Extreme heat protection",
    category: "Heatwave",
    summary: "Hydrate, avoid outdoor activity 10 AM–4 PM, check on vulnerable neighbors.",
  },
  {
    id: "f5",
    title: "Storm & tornado shelter",
    category: "Storm",
    summary: "Interior windowless room on lowest floor. Cover with blankets.",
  },
  {
    id: "f6",
    title: "Power outage preparedness",
    category: "Public Safety",
    summary: "Keep refrigerator closed, unplug electronics, use flashlights not candles.",
  },
];
...
export const notifications: Notif[] = [
  {
    id: "n1",
    title: "New Coastal Flood Warning issued for your area",
    time: mins(4),
    kind: "alert",
  },
  {
    id: "n2",
    title: "Storm coverage: Pacific low intensifies overnight",
    time: mins(22),
    kind: "news",
  },
