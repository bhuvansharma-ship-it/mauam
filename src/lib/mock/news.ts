export type NewsCategory =
  | "Weather" | "Floods" | "Cyclones" | "Heatwaves" | "Storms"
  | "Landslides" | "Earthquakes" | "Wildfires"
  | "Public Safety" | "Health Advisories" | "Transportation" | "Government Alerts";
...
function ago(mins: number) { const d = new Date(); d.setMinutes(d.getMinutes() - mins); return d.toISOString(); }

export const articles: Article[] = [
  {
    id: "n1", slug: "coastal-flood-warning-bay-area",
    headline: "Coastal Flood Warning issued for San Francisco Bay through evening",
    summary: "High tides combined with a Pacific storm system are expected to inundate low-lying coastal roads. Residents urged to avoid Embarcadero, Marina, and Ocean Beach approaches.",
    ...
    category: "Floods", severity: "breaking", location: "San Francisco, CA", publishedAt: ago(12),
    source: S.nws, image: { hue: 235, icon: "flood" }, pinned: true, trending: true,
  },
  {
    id: "n2", slug: "pacific-storm-intensifies",
    headline: "Pacific low intensifies overnight, wind gusts up to 60 mph forecast",
    summary: "A rapidly deepening low pressure system offshore will bring damaging winds and heavy rain to the Northern California coast overnight.",
    ...
    category: "Storms", severity: "critical", location: "Northern California", publishedAt: ago(35),
    source: S.reuters, image: { hue: 290, icon: "storm" }, trending: true,
  },
  {
    id: "n3", slug: "governor-declares-state-emergency",
    headline: "Governor declares state of emergency for six coastal counties",
    summary: "The declaration unlocks state and federal resources ahead of an anticipated 72-hour severe weather event.",
    ...
    category: "Government Alerts", severity: "official", location: "State of California", publishedAt: ago(70),
    source: S.fema, image: { hue: 260, icon: "gov" }, pinned: true,
  },
  {
    id: "n4", slug: "highway-101-southbound-closed",
    headline: "Highway 101 southbound closed at Sierra Point due to flooding",
    summary: "Caltrans crews are on scene. Detour via I-280 southbound; expect delays of 45-60 minutes.",
    ...
    category: "Transportation", severity: "advisory", location: "San Mateo County, CA", publishedAt: ago(95),
    source: S.dot, image: { hue: 45, icon: "road" }, trending: true,
  },
  {
    id: "n5", slug: "sfusd-early-dismissal",
    headline: "SFUSD announces early dismissal across all K-12 schools",
    summary: "All San Francisco Unified schools will dismiss at 12:30 PM today. After-school programs cancelled.",
    ...
    category: "Public Safety", severity: "official", location: "San Francisco, CA", publishedAt: ago(130),
    source: S.local, image: { hue: 200, icon: "gov" },
  },
  {
    id: "n6", slug: "pge-widespread-outages-expected",
    headline: "PG&E warns of widespread power outages during peak wind event",
    summary: "Public Safety Power Shutoffs (PSPS) may affect up to 180,000 customers across the Bay Area.",
    ...
    category: "Public Safety", severity: "advisory", location: "Bay Area", publishedAt: ago(180),
    source: S.local, image: { hue: 45, icon: "wind" },
  },
  {
    id: "n7", slug: "wildfire-contained-lake-county",
    headline: "Wildfire near Clear Lake now 60% contained after 4 days",
    summary: "Cal Fire reports significant progress on the Ridge Fire as cooler temperatures and higher humidity aid containment.",
    ...
    category: "Wildfires", severity: "info", location: "Lake County, CA", publishedAt: ago(240),
    source: S.ap, image: { hue: 25, icon: "fire" }, trending: true,
  },
  {
    id: "n8", slug: "heat-advisory-central-valley",
    headline: "Excessive Heat Warning for Central Valley through weekend",
    summary: "Temperatures may exceed 108°F. Cooling centers open in Sacramento, Stockton, and Fresno.",
    ...
    category: "Heatwaves", severity: "advisory", location: "Central Valley, CA", publishedAt: ago(300),
    source: S.nws, image: { hue: 50, icon: "heat" },
  },
  {
    id: "n9", slug: "cdc-air-quality-guidance",
    headline: "CDC issues respiratory health guidance for wildfire smoke exposure",
    summary: "Vulnerable populations urged to limit outdoor exposure and use N95 masks when AQI exceeds 150.",
    ...
    category: "Health Advisories", severity: "official", location: "Western United States", publishedAt: ago(420),
    source: S.cdc, image: { hue: 195, icon: "health" },
  },
  {
    id: "n10", slug: "landslide-highway-1-big-sur",
    headline: "Landslide closes Highway 1 near Big Sur; reopening unclear",
    summary: "A significant slide covers both lanes of Highway 1 south of Bixby Bridge. Caltrans engineers evaluating stability.",
    ...
    category: "Landslides", severity: "advisory", location: "Big Sur, CA", publishedAt: ago(560),
    source: S.dot, image: { hue: 30, icon: "road" },
  },
  {
    id: "n11", slug: "magnitude-4-2-earthquake-hollister",
    headline: "Magnitude 4.2 earthquake reported near Hollister, no damage",
    summary: "USGS confirms a magnitude 4.2 quake at 3:14 AM. Lightly felt across South Bay. No damage or injuries reported.",
    ...
    category: "Earthquakes", severity: "info", location: "Hollister, CA", publishedAt: ago(720),
    source: S.ap, image: { hue: 280, icon: "quake" },
  },
  {
    id: "n12", slug: "cyclone-forms-off-baja",
    headline: "Tropical cyclone forms off Baja coast, monitored for Pacific track",
    summary: "The National Hurricane Center is tracking a newly-named tropical storm that may influence Southern California moisture.",
    ...
    category: "Cyclones", severity: "info", location: "Pacific Ocean", publishedAt: ago(880),
    source: S.reuters, image: { hue: 250, icon: "storm" },
  },
];
