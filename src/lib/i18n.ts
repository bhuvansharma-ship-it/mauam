...
const resources = {
  en: {
    translation: {
      ...
      notifications: {
        ...
        empty: "No notifications for this location right now.",
      },
      knowledge: {
        title: "Knowledge Hub",
        before: "Before",
      ...
      settings: {
        ...
        mirrorNote: "This mirrors the location selected on your dashboard.",
      },
  ...
  hi: {
    translation: {
      ...
      settings: {
        ...
        mirrorNote: "यह आपके डैशबोर्ड पर चयनित स्थान को दर्शाता है।",
      },
  ...
  mr: {
    translation: {
      ...
      notifications: {
        title: "अलीकडील सूचना",
        empty: "या स्थानासाठी सध्या कोणत्याही सूचना नाहीत.",
      },
      knowledge: {
        title: "माहिती केंद्र",
        before: "आधी",
      ...
      settings: {
        ...
        language: "भाषा",
        notifications: "सूचना",
        mirrorNote: "हे तुमच्या डॅशबोर्डवर निवडलेले स्थान दर्शवते.",
      },
  ...
  es: {
    translation: {
      ...
      notifications: {
        ...
        empty: "No hay notificaciones para esta ubicación.",
      },
      knowledge: {
      ...
      settings: {
        ...
        mirrorNote: "Refleja la ubicación seleccionada en tu panel.",
      },
  ...
  ar: {
    translation: {
      ...
      settings: {
        ...
        mirrorNote: "يعكس الموقع المحدد في لوحة التحكم.",
      },
