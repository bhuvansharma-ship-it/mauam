      ...
      <GlassCard>
        <div className="p-5">
          <div className="mb-3 flex items-center gap-2">
            <span className="grid h-6 w-6 place-items-center rounded-full bg-news-official/20"><TrendingUp className="h-3.5 w-3.5 text-news-official" aria-hidden="true" /></span>
