    ...
    <GlassCard className="col-span-12 sm:col-span-6 lg:col-span-4">
      <div className="p-5 sm:p-6">
        ...
        <div className="mb-4 h-1.5 overflow-hidden rounded-full bg-muted/60">
          <div
            className="h-full rounded-full bg-gradient-to-r from-weather-safe to-primary"
                      ...
                      >
                        <span
                          className={cn(
                            ...
                            i.done
                              ? "border-weather-safe bg-weather-safe text-background"
                              : "border-muted-foreground/40",
                          )}
                        >
                          {i.done && <Check className="h-3.5 w-3.5" />}
                        </span>
                        <span className={cn(i.done && "text-muted-foreground line-through")}>
                          {i.text}
                        </span>
                      </button>
                    </li>
