    ...
    <div className="space-y-8">
      <header>
        ...
        <p className="mt-2 max-w-2xl text-sm text-muted-foreground">
          Clear, calm guidance drawn from trusted emergency-management agencies — CDC, NOAA, NDMA,
          USGS and Ready.gov. Each topic covers what to do before, during and after, plus the
          mistakes that cause most injuries.
        </p>
      </header>
                ...
                <article className="p-5 sm:p-6">
                  <div className="flex items-start gap-4">
                    <div
                      ...
                      style={{
                        backgroundImage: `linear-gradient(135deg, hsl(${topic.hue} 85% 55%), hsl(${(topic.hue + 40) % 360} 85% 55%))`,
                      }}
                    >
